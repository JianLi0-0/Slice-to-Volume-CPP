...
SliceType::Pointer ExtractSliceFromVolume2(VolumeType::Pointer volume, TransformType::Pointer transformation, float sliceWidth, float sliceHeight, VolumeType::SpacingType outputSpacing);
